...
class Config:
    ...
    use_automated_curriculum: bool = False  # 是否启用自动课程学习。如果为True，环境难度(p_flicker)会根据智能体表现自动调整。
...
class PPO(Environment):
    def __init__(self, args: Config = Config()):
        ...
        super(PPO, self).__init__(0, "cuda", requires_grad=True, args=self.args, render_mode="human")
