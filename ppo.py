...
class PPO:
    def __init__(self, gid="LunarLanderContinuous-v2", render_mode = None):
        ...
        #self.sub_envs.append(Environment(0, gid=self.gid, render_mode="human", device="cuda", timesteps_per_batch=4800, max_timesteps_per_episode=self.max_timesteps_per_episode))
        self.i = 0
